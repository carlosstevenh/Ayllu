package com.example.edwin.ayllu.domain.tramo;
...
public class Tramo {
    ...
    public ContentValues toContentValues() {
        ...
        values.put(TramoContract.TramoEntry.CODIGO, codigo_t);
        values.put(TramoContract.TramoEntry.DESCRIPCION, descripcion_t);
        values.put(TramoContract.TramoEntry.PAIS, pais_t);
        return values;
    }
