package com.example.edwin.ayllu.domain.seccion;
...
public class Seccion {
    ...
    public ContentValues toContentValues() {
        ...
        values.put(SeccionContract.SeccionEntry.CODIGO, codigo_sec);
        values.put(SeccionContract.SeccionEntry.DESCRIPCION, descripcion_sec);
        values.put(SeccionContract.SeccionEntry.SUBTRAMO, subtramo_sec);
        return values;
    }
