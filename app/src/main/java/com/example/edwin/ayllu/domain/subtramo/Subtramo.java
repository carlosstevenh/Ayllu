package com.example.edwin.ayllu.domain.subtramo;
...
public class Subtramo {
    ...
    public ContentValues toContentValues() {
        ...
        values.put(SubtramoContract.SubtramoEntry.CODIGO, codigo_sub);
        values.put(SubtramoContract.SubtramoEntry.DESCRIPCION, descripcion_sub);
        values.put(SubtramoContract.SubtramoEntry.TRAMO, tramo_sub);
        return values;
    }
